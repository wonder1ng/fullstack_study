...
public class MainController {
    // localhost:8090
    @GetMapping("/") // GET 요청을 처리하는 메소드 위에 선언한다.
    @ResponseBody  // 응답을 html로 하지 않고, Body 데이터(문자열)로 처리한다.
    public String main() {
    ...
    // 3. 생성자 주입 - 권장
    // 권장 이유(장점)
    // 1) final 키워드 사용 가능(객체 재할당 제한)
    // 2) 생성자로서 주입을 우선적으로 받을 수 있다. null safety 제공
