...
export function ControledForm() {
  ...
  const handleSubmit = (e) => {
    ...
    alert(
      `ControledForm: 입력값: ${inputValue}, 텍스트: ${textareaValue}, 선택값: ${selectValue}`
    );
  };
...
export function UncontrolledForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(
      `UncontrolledForm: 입력값: ${inputRef.current.value}, 텍스트: ${textareaRef.current.value}, 선택값: ${selectRef.current.value}`
    );
  };
